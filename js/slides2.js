    ...
    ! function(t, e, i) {
        ...
        function s() {
            ...
            for (var l in b) {
                ...
                for (s = n(e.fn, "function") ? e.fn() : e.fn, o = 0; o < t.length; o++) a = t[o], r = a.split("."), 1 === r.length ? S[r[0]] = s : 2 === r.length && (!S[r[0]] || S[r[0]] instanceof Boolean || (S[r[0]] = new Boolean(S[r[0]])), S[r[0]][r[1]] = s), v.push((s ? "" : "no-") + r.join("-"))
            }
        }
        ...
        function o(t) {
            ...
            e = e.replace(n, "$1" + i + "js$2"), S._config.enableClasses && (e += " " + i + t.join(" " + i), T.className = e)
        }
        ...
        var v = [],
            ...
            S = function() {};
        S.prototype = y, S = new S, S.addTest("applicationcache", "applicationCache" in t), S.addTest("history", function() {
        ...
        var T = e.documentElement,
            L = "Webkit Moz O ms",
            _ = y._config.usePrefixes ? L.toLowerCase().split(" ") : [];
        y._domPrefixes = _;
        var w = function() {
        ...
        var k = y.testStyles = r,
            C = y._config.usePrefixes ? L.split(" ") : [];
        y._cssomPrefixes = C;
        var A = {
            elem: w("modernizr")
        };
        ...
        y.testAllProps = m, y.testAllProps = g, S.addTest("backgroundsize", g("backgroundSize", "100%", !0)), S.addTest("cssanimations", g("animationName", "a", !0)), S.addTest("csstransforms", g("transform", "scale(1)", !0)), S.addTest("csstransforms3d", function() {
        ...
        var D = y.prefixed = function(t, e, i) {
            return -1 != t.indexOf("-") && (t = c(t)), e ? m(t, e, i) : m(t, "pfx")
        };
        S.addTest("fullscreen", !(!D("exitFullscreen", e, !1) && !D("cancelFullScreen", e, !1))), s(), o(v), delete y.addTest, delete y.addAsyncTest;
        for (var I = 0; I < S._q.length; I++) S._q[I]();
        t.Modernizr = S
    }(this, document),
    function(t, e) {
        ...
        function d(t, e, i, n) {
            if (se.acceptData(t)) {
                var s, o, a = se.expando,
                    ...
                    l = r ? se.cache : t,
                    c = r ? t[a] : t[a] && a;
                if (c && l[c] && (n || l[c].data) || void 0 !== i || "string" != typeof e) return c || (c = r ? t[a] = J.pop() || se.guid++ : a), l[c] || (l[c] = r ? {} : {
                    toJSON: se.noop
        ...
        function L(t, e) {
            ...
            if (1 === e.nodeType) {
                ...
                "script" === i && e.text !== t.text ? (y(e).text = t.text, S(e)) : "object" === i ? (e.parentNode && (e.outerHTML = t.outerHTML), ie.html5Clone && t.innerHTML && !se.trim(e.innerHTML) && (e.innerHTML = t.innerHTML)) : "input" === i && De.test(t.type) ? (e.defaultChecked = e.checked = t.checked, e.value !== t.value && (e.value = t.value)) : "option" === i ? e.defaultSelected = e.selected = t.defaultSelected : ("input" === i || "textarea" === i) && (e.defaultValue = t.defaultValue)
            }
        }
        ...
        function C(t, e) {
            if (e in t) return e;
            for (var i = e.charAt(0).toUpperCase() + e.slice(1), n = e, s = ui.length; s--;)
                if (e = ui[s] + i, e in t) return e;
            return n
        }
        ...
        function D(t, e, i, n, s) {
            for (var o = i === (n ? "border" : "content") ? 4 : "width" === e ? 1 : 0, a = 0; 4 > o; o += 2) "margin" === i && (a += se.css(t, i + Ce[o], !0, s)), n ? ("content" === i && (a -= se.css(t, "padding" + Ce[o], !0, s)), "margin" !== i && (a -= se.css(t, "border" + Ce[o] + "Width", !0, s))) : (a += se.css(t, "padding" + Ce[o], !0, s), "padding" !== i && (a += se.css(t, "border" + Ce[o] + "Width", !0, s)));
            return a
        }
        ...
        function O(t, e) {
            var i, n = {
                ...
                s = 0;
            for (e = e ? 1 : 0; 4 > s; s += 2 - e) i = Ce[s], n["margin" + i] = n["padding" + i] = t;
        ...
        function P(t, e, i) {
            ...
            if (se.isEmptyObject(u)) "inline" === ("none" === c ? w(t.nodeName) : c) && (p.display = c);
            else {
        ...
        function $(t, e, i) {
            var n, s, o = 0,
                ...
                d = c.props;
            for (U(d, c.opts.specialEasing); a > o; o++)
                if (n = bi[o].call(c, t, d, c.opts)) return n;
        ...
        function V(t, e, i, n) {
            ...
            if (se.isArray(e)) se.each(e, function(e, s) {
                i || Xi.test(t) ? n(t, s) : V(t + "[" + ("object" == typeof s ? e : "") + "]", s, i, n)
            });
        ...
        se.fn = se.prototype = {
            ...
            makeArray: function(t, e) {
                var n = e || [];
                return null != t && (i(Object(t)) ? se.merge(n, "string" == typeof t ? [t] : t) : K.call(n, t)), n
            },
            ...
            proxy: function(t, e) {
                var i, n, s;
                return "string" == typeof e && (s = t[e], e = t, t = s), se.isFunction(t) ? (i = Y.call(arguments, 2), n = function() {
        ...
        var ce = function(t) {
            function e(t, e, i, n) {
                ...
                if ((e ? e.ownerDocument || e : j) !== M && I(e), e = e || M, i = i || [], !t || "string" != typeof t) return i;
                ...
                if (O && !n) {
                    if (s = be.exec(t))
                        if (a = s[1]) {
                            ...
                            } else if (e.ownerDocument && (o = e.ownerDocument.getElementById(a)) && $(e, o) && o.id === a) return i.push(o), i
                        } else {
                            if (s[2]) return Z.apply(i, e.getElementsByTagName(t)), i;
                            if ((a = s[3]) && E.getElementsByClassName && e.getElementsByClassName) return Z.apply(i, e.getElementsByClassName(a)), i
                        }
                    if (E.qsa && (!N || !N.test(t))) {
                        if (p = h = F, f = e, m = 9 === r && t, 1 === r && "object" !== e.nodeName.toLowerCase()) {
                            for (c = w(t), (h = e.getAttribute("id")) ? p = h.replace(Se, "\\$&") : e.setAttribute("id", p), p = "[id='" + p + "'] ", l = c.length; l--;) c[l] = p + u(c[l]);
                            f = ye.test(t) && d(e.parentNode) || e, m = c.join(",")
                        }
                        if (m) try {
            ...
            function p(t, e, i) {
                ...
                return e.first ? function(e, i, o) {
                    ...
                    if (a) {
                        ...
                        for (; e = e[n];)
                            if (1 === e.nodeType || s) {
                                if (l = e[F] || (e[F] = {}), (r = l[n]) && r[0] === B && r[1] === o) return c[2] = r[2];
            ...
            function v(t, e, i, s, o, a) {
                return s && !s[F] && (s = v(s)), o && !o[F] && (o = v(o, a)), n(function(n, a, r, l) {
                    var c, d, h, u = [],
                        ...
                        y = i ? o || (n ? t : f || s) ? [] : a : b;
                    if (i && i(b, y, r, l), s)
                        for (c = g(y, p), s(c, [], r, l), d = c.length; d--;)(h = c[d]) && (y[p[d]] = !(b[p[d]] = h));
                    if (n) {
                        if (o || t) {
                            if (o) {
                            ...
                            for (d = y.length; d--;)(h = y[d]) && (c = o ? ee.call(n, h) : u[d]) > -1 && (n[c] = !(a[c] = h))
                        }
                    } else y = g(y === a ? y.splice(f, y.length) : y), o ? o(null, a, y, l) : Z.apply(a, y)
                })
            }
                ...
                var s = i.length > 0,
                    ...
                    a = function(n, a, r, l, c) {
                        var d, h, u, p = 0,
                            ...
                            b = A,
                            y = n || o && T.find.TAG("*", c),
                            S = B += null == b ? 1 : Math.random() || .1,
                            E = y.length;
                        for (c && (A = a !== M && a); f !== E && null != (d = y[f]); f++) {
                            if (o && d) {
                                for (h = 0; u = t[h++];)
                                    if (u(d, a, r)) {
                                        l.push(d);
            ...
            var S, E, T, L, _, w, k, C, A, x, D, I, M, R, O, N, P, U, $, F = "sizzle" + -new Date,
                j = t.document,
                B = 0,
                H = 0,
                z = i(),
            ...
            E = e.support = {}, _ = e.isXML = function(t) {
                ...
                return i !== M && 9 === i.nodeType && i.documentElement ? (M = i, R = i.documentElement, O = !_(i), n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", function() {
                    ...
                    return R.appendChild(t).id = F, !i.getElementsByName || !i.getElementsByName(F).length
                ...
                })), (E.matchesSelector = ve.test(U = R.matches || R.webkitMatchesSelector || R.mozMatchesSelector || R.oMatchesSelector || R.msMatchesSelector)) && s(function(t) {
                    E.disconnectedMatch = U.call(t, "div"), U.call(t, "[s!='']:x"), P.push("!=", re)
                }), N = N.length && new RegExp(N.join("|")), P = P.length && new RegExp(P.join("|")), e = ve.test(R.compareDocumentPosition), $ = e || ve.test(R.contains) ? function(t, e) {
                    ...
                    return n ? n : (n = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1, 1 & n || !E.sortDetached && e.compareDocumentPosition(t) === n ? t === i || t.ownerDocument === j && $(j, t) ? -1 : e === i || e.ownerDocument === j && $(j, e) ? 1 : x ? ee.call(x, t) - ee.call(x, e) : 0 : 4 & n ? -1 : 1)
                } : function(t, e) {
                    if (t === e) return D = !0, 0;
                    var n, s = 0,
                        o = t.parentNode,
                    ...
                    for (; l[s] === c[s];) s++;
                    return s ? a(l[s], c[s]) : l[s] === j ? -1 : c[s] === j ? 1 : 0
                }, i) : M
            }, e.matches = function(t, i) {
                return e(t, null, null, i)
            }, e.matchesSelector = function(t, i) {
                if ((t.ownerDocument || t) !== M && I(t), i = i.replace(he, "='$1']"), !(!E.matchesSelector || !O || P && P.test(i) || N && N.test(i))) try {
                    var n = U.call(t, i);
                ...
                var e, i = [],
                    n = 0,
                    s = 0;
                if (D = !E.detectDuplicates, x = !E.sortStable && t.slice(0), t.sort(W), D) {
                ...
                filter: {
                    ...
                    CHILD: function(t, e, i, n, s) {
                        ...
                        return 1 === n && 0 === s ? function(t) {
                            ...
                            var c, d, h, u, p, f, m = o !== a ? "nextSibling" : "previousSibling",
                                g = e.parentNode,
                            ...
                            if (g) {
                                ...
                                if (f = [a ? g.firstChild : g.lastChild], a && b) {
                                    for (d = g[F] || (g[F] = {}), c = d[t] || [], p = c[0] === B && c[1], u = c[0] === B && c[2], h = p && g.childNodes[p]; h = ++p && h && h[m] || (u = p = 0) || f.pop();)
                                        if (1 === h.nodeType && ++u && h === e) {
                                            d[t] = [B, p, u];
                                            break
                                        }
                                } else if (b && (c = (e[F] || (e[F] = {}))[t]) && c[0] === B) u = c[1];
                                else
                                    for (;
                                        (h = ++p && h && h[m] || (u = p = 0) || f.pop()) && ((r ? h.nodeName.toLowerCase() !== v : 1 !== h.nodeType) || !++u || (b && ((h[F] || (h[F] = {}))[t] = [B, u]), h !== e)););
            ...
            return h.prototype = T.filters = T.pseudos, T.setFilters = new h, w = e.tokenize = function(t, i) {
                ...
                var i, n = [],
                    ...
                    o = G[t + " "];
                if (!o) {
                    for (e || (e = w(t)), i = e.length; i--;) o = b(e[i]), o[F] ? n.push(o) : s.push(o);
                    o = G(t, y(s, n)), o.selector = t
                }
                return o
            }, C = e.select = function(t, e, i, n) {
                var s, o, a, r, l, c = "function" == typeof t && t,
                    h = !n && w(t = c.selector || t);
                if (i = i || [], 1 === h.length) {
                    ...
                    for (s = fe.needsContext.test(t) ? 0 : o.length; s-- && (a = o[s], !T.relative[r = a.type]);)
                        if ((l = T.find[r]) && (n = l(a.matches[0].replace(Ee, Te), ye.test(o[0].type) && d(e.parentNode) || e))) {
                            if (o.splice(s, 1), t = n.length && u(o), !t) return Z.apply(i, n), i;
                            break
                        }
                }
                return (c || k(t, h))(n, e, !O, i, ye.test(t) && d(e.parentNode) || e), i
            }, E.sortStable = F.split("").sort(W).join("") === F, E.detectDuplicates = !!D, I(), E.sortDetached = s(function(t) {
        ...
        se.Callbacks = function(t) {
            ...
            when: function(t) {
                var e, i, n, s = 0,
                    ...
                    c = function(t, i, n) {
                        return function(s) {
                            i[t] = this, n[t] = arguments.length > 1 ? Y.call(arguments) : s, n === e ? l.notifyWith(i, n) : --r || l.resolveWith(i, n)
                        }
                    };
                if (a > 1)
        ...
        se.event = {
            ...
            add: function(t, e, i, n, s) {
                ...
                if (g) {
                    for (i.handler && (l = i, i = l.handler, s = l.selector), i.guid || (i.guid = se.guid++), (a = g.events) || (a = g.events = {}), (d = g.handle) || (d = g.handle = function(t) {
                        ...
                        }, d.elem = t), e = (e || "").match(ye) || [""], r = e.length; r--;) o = Ne.exec(e[r]) || [], p = m = o[1], f = (o[2] || "").split(".").sort(), p && (c = se.event.special[p] || {}, p = (s ? c.delegateType : c.bindType) || p, c = se.event.special[p] || {}, h = se.extend({
                        type: p,
                        origType: m,
                        data: n,
                        handler: i,
            ...
            trigger: function(e, i, n, s) {
                ...
                if (r = d = n = n || fe, 3 !== n.nodeType && 8 !== n.nodeType && !Oe.test(p + se.event.triggered) && (p.indexOf(".") >= 0 && (f = p.split("."), p = f.shift(), f.sort()), a = p.indexOf(":") < 0 && "on" + p, e = e[se.expando] ? e : new se.Event(p, "object" == typeof e && e), e.isTrigger = s ? 2 : 3, e.namespace = f.join("."), e.namespace_re = e.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), i = null == i ? [e] : se.makeArray(i, [e]), c = se.event.special[p] || {}, s || !c.trigger || c.trigger.apply(n, i) !== !1)) {
                    ...
                    for (h = 0;
                        (r = u[h++]) && !e.isPropagationStopped();) e.type = h > 1 ? l : c.bindType || p, o = (se._data(r, "events") || {})[e.type] && se._data(r, "handle"), o && o.apply(r, i), o = a && r[a], o && o.apply && se.acceptData(r) && (e.result = o.apply(r, i), e.result === !1 && e.preventDefault());
        ...
        Ye.optgroup = Ye.option, Ye.tbody = Ye.tfoot = Ye.colgroup = Ye.caption = Ye.thead, Ye.th = Ye.td, se.extend({
            clone: function(t, e, i) {
                var n, s, o, a, r, l = se.contains(t.ownerDocument, t);
                if (ie.html5Clone || se.isXMLDoc(t) || !$e.test("<" + t.nodeName + ">") ? o = t.cloneNode(!0) : (Ke.innerHTML = t.outerHTML, Ke.removeChild(o = Ke.firstChild)), !(ie.noCloneEvent && ie.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || se.isXMLDoc(t)))
                    for (n = g(o), r = g(t), a = 0; null != (s = r[a]); ++a) n[a] && L(s, n[a]);
                if (e)
                    if (i)
                        for (r = r || g(t), n = n || g(o), a = 0; null != (s = r[a]); a++) T(s, n[a]);
                    else T(t, o);
                return n = g(o, "script"), n.length > 0 && E(n, !l && g(t, "script")), n = r = s = null, o
            },
            buildFragment: function(t, e, i, n) {
                for (var s, o, a, r, l, c, d, h = t.length, u = m(e), p = [], f = 0; h > f; f++)
                    if (o = t[f], o || 0 === o)
                        if ("object" === se.type(o)) se.merge(p, o.nodeType ? [o] : o);
                        else if (ze.test(o)) {
                    for (r = r || u.appendChild(e.createElement("div")), l = (Be.exec(o) || ["", ""])[1].toLowerCase(), d = Ye[l] || Ye._default, r.innerHTML = d[1] + o.replace(je, "<$1></$2>") + d[2], s = d[0]; s--;) r = r.lastChild;
                    if (!ie.leadingWhitespace && Fe.test(o) && p.push(e.createTextNode(Fe.exec(o)[0])), !ie.tbody)
                ...
                for (r && u.removeChild(r), ie.appendChecked || se.grep(g(p, "input"), v), f = 0; o = p[f++];)
                    if ((!n || -1 === se.inArray(o, n)) && (a = se.contains(o.ownerDocument, o), r = g(u.appendChild(o), "script"), a && E(r), i))
                        for (s = 0; o = r[s++];) We.test(o.type || "") && i.push(o);
                return r = null, u
            },
            cleanData: function(t, e) {
                for (var i, n, s, o, a = 0, r = se.expando, l = se.cache, c = ie.deleteExpando, d = se.event.special; null != (i = t[a]); a++)
                    if ((e || se.acceptData(i)) && (s = i[r], o = s && l[s])) {
                        ...
                        l[s] && (delete l[s], c ? delete i[r] : typeof i.removeAttribute !== Le ? i.removeAttribute(r) : i[r] = null, J.push(s))
                    }
            }
        }), se.fn.extend({
            text: function(t) {
            ...
            remove: function(t, e) {
                for (var i, n = t ? se.filter(t, this) : this, s = 0; null != (i = n[s]); s++) e || 1 !== i.nodeType || se.cleanData(g(i)), i.parentNode && (e && se.contains(i.ownerDocument, i) && E(g(i, "script")), i.parentNode.removeChild(i));
                return this
            },
            empty: function() {
            ...
            html: function(t) {
                return xe(this, function(t) {
                    var e = this[0] || {},
                        i = 0,
                        n = this.length;
                    if (void 0 === t) return 1 === e.nodeType ? e.innerHTML.replace(Ue, "") : void 0;
                    if (!("string" != typeof t || Ve.test(t) || !ie.htmlSerialize && $e.test(t) || !ie.leadingWhitespace && Fe.test(t) || Ye[(Be.exec(t) || ["", ""])[1].toLowerCase()])) {
                        t = t.replace(je, "<$1></$2>");
                        try {
            ...
            domManip: function(t, e) {
                ...
                var i, n, s, o, a, r, l = 0,
                    ...
                    u = t[0],
                    p = se.isFunction(u);
                if (p || c > 1 && "string" == typeof u && !ie.checkClone && Ge.test(u)) return this.each(function(i) {
                    var n = d.eq(i);
                ...
                if (c && (r = se.buildFragment(t, this[0].ownerDocument, !1, this), i = r.firstChild, 1 === r.childNodes.length && (r = i), i)) {
                    for (o = se.map(g(r, "script"), y), s = o.length; c > l; l++) n = r, l !== h && (n = se.clone(n, !0, !0), s && se.merge(o, g(n, "script"))), e.call(this[l], n, l);
                    if (s)
                        for (a = o[o.length - 1].ownerDocument, se.map(o, S), l = 0; s > l; l++) n = o[l], We.test(n.type || "") && !se._data(n, "globalEval") && se.contains(a, n) && (n.src ? se._evalUrl && se._evalUrl(n.src) : se.globalEval((n.text || n.textContent || n.innerHTML || "").replace(Je, "")));
                    r = i = null
                }
                return this
            }
            ...
            se.fn[t] = function(t) {
                for (var i, n = 0, s = [], o = se(t), a = o.length - 1; a >= n; n++) i = n === a ? this : this.clone(!0), se(o[n])[e](i), K.apply(s, i.get());
        ...
        se.extend({
            ...
            css: function(t, e, i, n) {
                var s, o, a, r = se.camelCase(e);
                return e = se.cssProps[r] || (se.cssProps[r] = C(t.style, r)), a = se.cssHooks[e] || se.cssHooks[r], a && "get" in a && (o = a.get(t, !0, i)), void 0 === o && (o = ei(t, e, n)), "normal" === o && e in hi && (o = hi[e]), "" === i || i ? (s = parseFloat(o), i === !0 || se.isNumeric(s) ? s || 0 : o) : o
            }
            ...
            se.cssHooks[t + e] = {
                expand: function(i) {
                    for (var n = 0, s = {}, o = "string" == typeof i ? i.split(" ") : [i]; 4 > n; n++) s[t + Ce[n] + e] = o[n] || o[n - 2] || o[0];
                    return s
                }
        ...
        se.fn.extend({
            val: function(t) {
                var e, i, n, s = this[0]; {
                    ...
                    if (s) return e = se.valHooks[s.type] || se.valHooks[s.nodeName.toLowerCase()], e && "get" in e && void 0 !== (i = e.get(s, "value")) ? i : (i = s.value, "string" == typeof i ? i.replace(Si, "") : null == i ? "" : i)
                }
            }
        }), se.extend({
            valHooks: {
        ...
        se.fn.extend({
            ...
            removeAttr: function(t, e) {
                var i, n, s = 0,
                    o = e && e.match(ye);
                if (o && 1 === t.nodeType)
                    for (; i = o[s++];) n = se.propFix[i] || i, se.expr.match.bool.test(i) ? ki && wi || !_i.test(i) ? t[n] = !1 : t[se.camelCase("default-" + i)] = t[n] = !1 : se.attr(t, i, ""), t.removeAttribute(wi ? i : n)
            },
            attrHooks: {
                type: {
                    set: function(t, e) {
            ...
            set: function(t, e, i) {
                return e === !1 ? se.removeAttr(t, i) : ki && wi || !_i.test(i) ? t.setAttribute(!wi && se.propFix[i] || i, i) : t[se.camelCase("default-" + i)] = t[i] = !0, i
            }
        }, se.each(se.expr.match.bool.source.match(/\w+/g), function(t, e) {
            var i = Li[e] || se.find.attr;
            Li[e] = ki && wi || !_i.test(e) ? function(t, e, n) {
                var s, o;
        ...
        se.fn.extend({
            addClass: function(t) {
                ...
                if (c)
                    for (e = (t || "").match(ye) || []; l > r; r++)
                        if (i = this[r], n = 1 === i.nodeType && (i.className ? (" " + i.className + " ").replace(xi, " ") : " ")) {
            ...
            hasClass: function(t) {
                for (var e = " " + t + " ", i = 0, n = this.length; n > i; i++)
                    if (1 === this[i].nodeType && (" " + this[i].className + " ").replace(xi, " ").indexOf(e) >= 0) return !0;
                return !1
            }
        ...
        Ri = Bi.exec(Oi.toLowerCase()) || [], se.extend({
            active: 0,
            lastModified: {},
            etag: {},
            ajaxSettings: {
            ...
            ajax: function(t, e) {
                function i(t, e, i, n) {
                    var s, d, v, b, S, T = e;
                    2 !== y && (y = 2, r && clearTimeout(r), c = void 0, a = n || "", E.readyState = t > 0 ? 4 : 0, s = t >= 200 && 300 > t || 304 === t, i && (b = H(h, E, i)), b = z(h, b, E, s), s ? (h.ifModified && (S = E.getResponseHeader("Last-Modified"), S && (se.lastModified[o] = S), S = E.getResponseHeader("etag"), S && (se.etag[o] = S)), 204 === t || "HEAD" === h.type ? T = "nocontent" : 304 === t ? T = "notmodified" : (T = b.state, d = b.data, v = b.error, s = !v)) : (v = T, (t || !T) && (T = "error", 0 > t && (t = 0))), E.status = t, E.statusText = (e || T) + "", s ? f.resolveWith(u, [d, T, E]) : f.rejectWith(u, [E, T, v]), E.statusCode(g), g = void 0, l && p.trigger(s ? "ajaxSuccess" : "ajaxError", [E, h, s ? d : v]), m.fireWith(u, [E, T]), l && (p.trigger("ajaxComplete", [E, h]), --se.active || se.event.trigger("ajaxStop")))
                }
                "object" == typeof t && (e = t, t = void 0), e = e || {};
                var n, s, o, a, r, l, c, d, h = se.ajaxSetup({}, e),
                    u = h.context || h,
                    ...
                    E = {
                        ...
                        getResponseHeader: function(t) {
                            ...
                            if (2 === y) {
                                if (!d)
                                    for (d = {}; e = Ui.exec(a);) d[e[1].toLowerCase()] = e[2];
                                e = d[t.toLowerCase()]
                            }
                ...
                if (f.promise(E).complete = m.add, E.success = E.done, E.error = E.fail, h.url = ((t || h.url || Oi) + "").replace(Ni, "").replace(ji, Ri[1] + "//"), h.type = e.method || e.type || h.method || h.type, h.dataTypes = se.trim(h.dataType || "*").toLowerCase().match(ye) || [""], null == h.crossDomain && (n = Bi.exec(h.url.toLowerCase()), h.crossDomain = !(!n || n[1] === Ri[1] && n[2] === Ri[2] && (n[3] || ("http:" === n[1] ? "80" : "443")) === (Ri[3] || ("http:" === Ri[1] ? "80" : "443")))), h.data && h.processData && "string" != typeof h.data && (h.data = se.param(h.data, h.traditional)), j(Hi, h, e, E), 2 === y) return E;
                l = h.global, l && 0 === se.active++ && se.event.trigger("ajaxStart"), h.type = h.type.toUpperCase(), h.hasContent = !Fi.test(h.type), o = h.url, h.hasContent || (h.data && (o = h.url += (Ii.test(o) ? "&" : "?") + h.data, delete h.data), h.cache === !1 && (h.url = Pi.test(o) ? o.replace(Pi, "$1_=" + Di++) : o + (Ii.test(o) ? "&" : "?") + "_=" + Di++)), h.ifModified && (se.lastModified[o] && E.setRequestHeader("If-Modified-Since", se.lastModified[o]), se.etag[o] && E.setRequestHeader("If-None-Match", se.etag[o])), (h.data && h.hasContent && h.contentType !== !1 || e.contentType) && E.setRequestHeader("Content-Type", h.contentType), E.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + Vi + "; q=0.01" : "") : h.accepts["*"]);
                for (s in h.headers) E.setRequestHeader(s, h.headers[s]);
                if (h.beforeSend && (h.beforeSend.call(u, E, h) === !1 || 2 === y)) return E.abort();
                S = "abort";
                for (s in {
                        success: 1,
                        error: 1,
                ...
                if (c = j(zi, h, e, E)) {
                    E.readyState = 1, l && p.trigger("ajaxSend", [E, h]), h.async && h.timeout > 0 && (r = setTimeout(function() {
                        E.abort("timeout")
                    }, h.timeout));
                    try {
                        y = 1, c.send(v, i)
        ...
        se.param = function(t, e) {
            ...
            serializeArray: function() {
                return this.map(function() {
                    ...
                    var t = this.type;
                    return this.name && !se(this).is(":disabled") && qi.test(this.nodeName) && !Yi.test(t) && (this.checked || !De.test(t))
                }).map(function(t, e) {
                    var i = se(this).val();
            ...
            return !this.isLocal && /^(get|post|head|put|delete|options)$/i.test(this.type) && G() || W()
        } : G;
        var Ki = 0,
            Qi = {},
        ...
        se.offset = {
            ...
            offset: function(t) {
                ...
                var e, i, n = {
                    ...
                    s = this[0],
                    o = s && s.ownerDocument;
                if (o) return e = o.documentElement, se.contains(e, s) ? (typeof s.getBoundingClientRect !== Le && (n = s.getBoundingClientRect()), i = X(o), {
    ...
    function() {
        var t, e, i, n, s, o, a, r, l, c, d, h, u, p, f, m, g, v, b, y = [].slice,
        ...
        t = jQuery, t.payment = {}, t.payment.fn = {}, t.fn.payment = function() {
            var e, i;
            return i = arguments[0], e = 2 <= arguments.length ? y.call(arguments, 1) : [], t.payment.fn[i].apply(this, e)
        }, s = /(\d{1,4})/g, n = [{
            type: "maestro",
            ...
            var i, n;
            return t = (t + "").replace(/\s+|-/g, ""), /^\d+$/.test(t) ? (i = e(t), i ? (n = t.length, S.call(i.length, n) >= 0 && (i.luhn === !1 || u(t))) : !1) : !1
            ...
            var s, o;
            return e = t.trim(e), /^\d+$/.test(e) ? n ? (s = e.length, S.call(null != (o = i(n)) ? o.cvcLength : void 0, s) >= 0) : e.length >= 3 && e.length <= 4 : !1
    ...
    function(t, e, i) {
        ...
        ! function(t, e, i, n) {
            ...
            function m(e) {
                ...
                U || H && H === n || (i = f("v" + e.type, e), i && (i.isDefaultPrevented() && e.preventDefault(), i.isPropagationStopped() && e.stopPropagation(), i.isImmediatePropagationStopped() && e.stopImmediatePropagation()))
            }

            function g(e) {
                var i, n, o, r = s(e).touches;
                r && 1 === r.length && (i = e.target, n = a(i), n.hasVirtualBinding && (H = B++, t.data(i, k, H), p(), h(), N = !1, o = s(e).touches[0], R = o.pageX, O = o.pageY, f("vmouseover", e, n), f("vmousedown", e, n)))
            }

            function v(t) {
                $ || (N || f("vmousecancel", t, a(t.target)), N = !0, u())
            }
            ...
            function T(e) {
                ...
                return {
                    setup: function() {
                        S(this) || t.data(this, w, {});
                        var n = t.data(this, w);
                        n[e] = !0, I[e] = (I[e] || 0) + 1, 1 === I[e] && j.bind(i, m), t(this).bind(i, E), F && (I.touchstart = (I.touchstart || 0) + 1, 1 === I.touchstart && j.bind("touchstart", g).bind("touchend", y).bind("touchmove", b).bind("scroll", v))
                    },
                    teardown: function() {
                        --I[e], I[e] || j.unbind(i, m), F && (--I.touchstart, I.touchstart || j.unbind("touchstart", g).unbind("touchmove", b).unbind("touchend", y).unbind("scroll", v));
                        var n = t(this),
                            s = t.data(this, w);
                        s && (s[e] = !1), n.unbind(i, E), S(this) || n.removeData(w)
                    }
                }
            }
    ...
    function(t) {
        ...
        var u, p, f = t.documentElement,
            ...
            v = {},
            b = {},
            y = t.createElement("script").async === !0 || "MozAppearance" in t.documentElement.style || window.opera,
...
JSON || (JSON = {}),
    ...
    function(t) {
        ...
        function c(t, e, i, n) {
            var s, o, a = e._milliseconds,
                r = e._days,
                l = e._months;
            a && t._d.setTime(+t._d + a * i), (r || l) && (s = t.minute(), o = t.hour()), r && t.date(t.date() + r * i), l && t.month(t.month() + l * i), a && !n && U.updateOffset(t), (r || l) && (t.minute(s), t.hour(o))
        }
        ...
        function p(t, e) {
            return e.abbr = t, B[t] || (B[t] = new n), B[t].set(e), B[t]
        }
        ...
        function m(t) {
            if (!t) return U.fn._lang;
            if (!B[t] && H) try {
                require("./lang/" + t)
            } catch (e) {
                return U.fn._lang
            }
            return B[t] || U.fn._lang
        }
        ...
        function b(t, e) {
            return e = y(e, t.lang()), ce[e] || (ce[e] = v(e)), ce[e](t)
        }
        ...
        function k(t) {
            var e, i, n, s = m(t._l),
                o = "" + t._i;
            for (n = y(t._f, s).match(G), t._a = [], e = 0; e < n.length; e++) i = (S(n[e], t).exec(o) || [])[0], i && (o = o.slice(o.indexOf(i) + i.length)), ue[n[e]] && T(n[e], i, t);
        ...
        function I(t, e, i) {
            var n = j(Math.abs(t) / 1e3),
                ...
                a = j(o / 24),
                r = j(a / 365),
                l = 45 > n && ["s", n] || 1 === s && ["m"] || 45 > s && ["mm", s] || 1 === o && ["h"] || 22 > o && ["hh", o] || 1 === a && ["d"] || 25 >= a && ["dd", a] || 45 >= a && ["M"] || 345 > a && ["MM", j(a / 30)] || 1 === r && ["y"] || ["yy", r];
        ...
        function M(t, e, i) {
            var n, s = i - e,
                o = i - t.day();
            return o > s && (o -= 7), s - 7 > o && (o += 7), n = U(t).add("d", o), {
        ...
        function R(t) {
            var e = t._i,
                i = t._f;
            return null === e || "" === e ? null : ("string" == typeof e && (t._i = e = m().preparse(e)), U.isMoment(e) ? (t = a({}, e), t._d = new Date(+e._d)) : i ? d(i) ? C(t) : k(t) : x(t), new s(t))
        }

        function O(t, e) {
            U.fn[t] = U.fn[t + "s"] = function(t) {
                var i = this._isUTC ? "UTC" : "";
                return null != t ? (this._d["set" + i + e](t), U.updateOffset(this), this) : this._d["get" + i + e]()
            }
        }

        function N(t) {
            U.duration.fn[t] = function() {
                return this._data[t]
            }
        }

        function P(t, e) {
            U.duration.fn["as" + t] = function() {
                return +this / e
            }
        }
        for (var U, $, F = "2.2.1", j = Math.round, B = {}, H = "undefined" != typeof module && module.exports, z = /^\/?Date\((\-?\d+)/i, V = /(\-)?(?:(\d*)\.)?(\d+)\:(\d+)\:(\d+)\.?(\d{3})?/, G = /(\[[^\[]*\])|(\\)?(Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|mm?|ss?|SS?S?|X|zz?|ZZ?|.)/g, W = /(\[[^\[]*\])|(\\)?(LT|LL?L?L?|l{1,4})/g, X = /\d\d?/, J = /\d{1,3}/, Y = /\d{3}/, q = /\d{1,4}/, K = /[+\-]?\d{1,6}/, Q = /[0-9]*['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+|[\u0600-\u06FF\/]+(\s*?[\u0600-\u06FF]+){1,2}/i, Z = /Z|[\+\-]\d\d:?\d\d/i, te = /T/i, ee = /[\+\-]?\d+(\.\d{1,3})?/, ie = /^\s*\d{4}-\d\d-\d\d((T| )(\d\d(:\d\d(:\d\d(\.\d\d?\d?)?)?)?)?([\+\-]\d\d:?\d\d)?)?/, ne = "YYYY-MM-DDTHH:mm:ssZ", se = [
            ...
            }; de.length;) $ = de.pop(), ue[$ + "o"] = i(ue[$], $);
        for (; he.length;) $ = he.pop(), ue[$ + $] = e(ue[$], 2);
        for (ue.DDDD = e(ue.DDD, 3), a(n.prototype, {
                ...
                monthsParse: function(t) {
                    ...
                    for (this._monthsParse || (this._monthsParse = []), e = 0; 12 > e; e++)
                        if (this._monthsParse[e] || (i = U.utc([2e3, e]), n = "^" + this.months(i, "") + "|^" + this.monthsShort(i, ""), this._monthsParse[e] = new RegExp(n.replace(".", ""), "i")), this._monthsParse[e].test(t)) return e
                },
                ...
                weekdaysParse: function(t) {
                    ...
                    for (this._weekdaysParse || (this._weekdaysParse = []), e = 0; 7 > e; e++)
                        if (this._weekdaysParse[e] || (i = U([2e3, 1]).day(e), n = "^" + this.weekdays(i, "") + "|^" + this.weekdaysShort(i, "") + "|^" + this.weekdaysMin(i, ""), this._weekdaysParse[e] = new RegExp(n.replace(".", ""), "i")), this._weekdaysParse[e].test(t)) return e
                },
                _longDateFormat: {
                    LT: "h:mm A",
                    L: "MM/DD/YYYY",
                ...
                return U(1e3 * t)
            }, U.duration = function(t, e) {
                var i, n, s = U.isDuration(t),
                    a = "number" == typeof t,
                    r = s ? t._input : a ? {} : t,
                    l = V.exec(t);
            ...
            }, U.version = F, U.defaultFormat = ne, U.updateOffset = function() {}, U.lang = function(t, e) {
                return t ? (t = t.toLowerCase(), t = t.replace("_", "-"), e ? p(t, e) : null === e ? (f(t), t = "en") : B[t] || m(t), void(U.duration.fn._lang = U.fn._lang = m(t))) : U.fn._lang._abbr
            }, U.langData = function(t) {
                return t && t._lang && t._lang._abbr && (t = t._lang._abbr), m(t)
            }, U.isMoment = function(t) {
                return t instanceof s
            }, U.isDuration = function(t) {
                ...
                toISOString: function() {
                    return b(U(this).utc(), "YYYY-MM-DD[T]HH:mm:ss.SSS[Z]")
                },
                toArray: function() {
                    var t = this;
                ...
                isValid: function() {
                    return null == this._isValid && (this._isValid = this._a ? !h(this._a, (this._isUTC ? U.utc(this._a) : U(this._a)).toArray()) : !isNaN(this._d.getTime())), !!this._isValid
                },
                invalidAt: function() {
                    var t, e = this._a,
                        i = (this._isUTC ? U.utc(this._a) : U(this._a)).toArray();
                ...
                format: function(t) {
                    var e = b(this, t || U.defaultFormat);
                    return this.lang().postformat(e)
                },
                add: function(t, e) {
                    var i;
                    return i = "string" == typeof t ? U.duration(+e, t) : U.duration(t, e), c(this, i, 1), this
                },
                ...
                diff: function(t, e, i) {
                    var n, s, o = this._isUTC ? U(t).zone(this._offset || 0) : U(t).local(),
                        a = 6e4 * (this.zone() - o.zone());
                    return e = u(e), "year" === e || "month" === e ? (n = 432e5 * (this.daysInMonth() + o.daysInMonth()), s = 12 * (this.year() - o.year()) + (this.month() - o.month()), s += (this - U(this).startOf("month") - (o - U(o).startOf("month"))) / n, s -= 6e4 * (this.zone() - U(this).startOf("month").zone() - (o.zone() - U(o).startOf("month").zone())) / n, "year" === e && (s /= 12)) : (n = this - o, s = "second" === e ? n / 1e3 : "minute" === e ? n / 6e4 : "hour" === e ? n / 36e5 : "day" === e ? (n - a) / 864e5 : "week" === e ? (n - a) / 6048e5 : n), i ? s : r(s)
                },
                from: function(t, e) {
                    return U.duration(this.diff(t)).lang(this.lang()._abbr).humanize(!e)
                },
                fromNow: function(t) {
                    return this.from(U(), t)
                },
                calendar: function() {
                    var t = this.diff(U().zone(this.zone()).startOf("day"), "days", !0),
                ...
                month: function(t) {
                    ...
                    return null != t ? "string" == typeof t && (t = this.lang().monthsParse(t), "number" != typeof t) ? this : (e = this.date(), this.date(1), this._d["set" + i + "Month"](t), this.date(Math.min(e, this.daysInMonth())), U.updateOffset(this), this) : this._d["get" + i + "Month"]()
                },
                startOf: function(t) {
                    switch (t = u(t)) {
                        case "year":
                ...
                isAfter: function(t, e) {
                    return e = "undefined" != typeof e ? e : "millisecond", +this.clone().startOf(e) > +U(t).startOf(e)
                },
                ...
                min: function(t) {
                    return t = U.apply(null, arguments), this > t ? this : t
                },
                max: function(t) {
                    return t = U.apply(null, arguments), t > this ? this : t
                },
                zone: function(t) {
                    var e = this._offset || 0;
                    return null == t ? this._isUTC ? e : this._d.getTimezoneOffset() : ("string" == typeof t && (t = E(t)), Math.abs(t) < 16 && (t = 60 * t), this._offset = t, this._isUTC = !0, e !== t && c(this, U.duration(e - t, "m"), 1, !0), this)
                },
                zoneAbbr: function() {
                ...
                hasAlignedHourOffset: function(t) {
                    return t = t ? U(t).zone() : 0, 0 === (this.zone() - t) % 60
                },
                daysInMonth: function() {
                    return U.utc([this.year(), this.month() + 1, 0]).date()
                },
                dayOfYear: function(t) {
                    var e = j((U(this).startOf("day") - U(this).startOf("year")) / 864e5) + 1;
            ...
            }), $ = 0; $ < ae.length; $++) O(ae[$].toLowerCase().replace(/s$/, ""), ae[$]);
        O("year", "FullYear"), U.fn.days = U.fn.day, U.fn.months = U.fn.month, U.fn.weeks = U.fn.week, U.fn.isoWeeks = U.fn.isoWeek, U.fn.toJSON = U.fn.toISOString, a(U.duration.fn = o.prototype, {
            _bubble: function() {
        ...
        for ($ in re) re.hasOwnProperty($) && (P($, re[$]), N($.toLowerCase()));
        P("Weeks", 6048e5), U.duration.fn.asMonths = function() {
        ...
        }), H && (module.exports = U), "undefined" == typeof ender && (this.moment = U), "function" == typeof define && define.amd && define("moment", [], function() {
            return U
        })
    }.call(this),
    function(t, e) {
    ...
    function(t, e) {
        ...
        function n(t) {
            for (var e = ["input", "textarea", "select"], i = [], n = 0; n < e.length; n++)
                for (var s = t.getElementsByTagName(e[n]), o = 0; o < s.length; o++) s[o].hasAttribute("required") && i.push(s[o]);
            return i
        }
                ...
                if ("function" == typeof t.addEventListener) {
                    ...
                    t.addEventListener("click", function() {
                        ...
                        if ("undefined" != typeof o)
                            for (var a = n(o), c = 0; c < a.length; c++) "" === a[c].value.replace(/^\s+|\s+$/g, "") && (e = !1), "checkbox" !== a[c].type && "radio" !== a[c].type || a[c].checked || (e = !1);
    ...
    function(t, e) {
        ...
        function S(t, e, i, n, s) {
            ...
            var o, r = t.split(" ");
            return r.length > 1 ? void v(t, r, e, i) : (o = y(t, i), A[o.key] = A[o.key] || [], a(o.key, o.modifiers, {
                type: o.action
        ...
        function E(t, e, i) {
            for (var n = 0; n < t.length; ++n) S(t[n], e, i)
        }
        for (var T, L, _ = {
                8: "backspace",
                9: "tab",
    ...
    function(t, e, i, n) {
        ...
        function w(t) {
            ...
            return new(e = i ? i : ve ? F : be ? H : ge ? V : $)(t, k)
        }
        ...
        function C(t, e) {
            ...
            var o = i.firstInput,
                ...
                l = e.center = I(n);
            e.timeStamp = pe(), e.deltaTime = e.timeStamp - o.timeStamp, e.angle = N(r, l), e.distance = O(r, l), A(i, e), e.offsetDirection = R(e.deltaX, e.deltaY), e.scale = a ? U(a.pointers, n) : 1, e.rotation = a ? P(a.pointers, n) : 0, x(i, e);
            var c = t.element;
        ...
        function P(t, e) {
            return N(e[1], e[0], Ue) - N(t[1], t[0], Ue)
        }

        function U(t, e) {
            return O(e[0], e[1], Ue) / O(t[0], t[1], Ue)
        }

        function $() {
            this.evEl = Fe, this.evWin = je, this.allow = !0, this.pressed = !1, _.apply(this, arguments)
        }
        ...
        function j() {
            this.evTarget = We, this.evWin = Xe, this.started = !1, _.apply(this, arguments)
        }

        function B(t, e) {
            var i = y(t.touches),
                n = y(t.changedTouches);
            return e & (ke | Ce) && (i = S(i.concat(n), "identifier", !0)), [i, n]
        }

        function H() {
            this.evTarget = Ye, this.targetIds = {}, _.apply(this, arguments)
        }
        ...
        function oe(t, e) {
            e = e || {}, this.options = l(e, se.defaults), this.options.inputTarget = this.options.inputTarget || t, this.handlers = {}, this.session = {}, this.recognizers = [], this.element = t, this.input = w(this), this.touchAction = new G(this, this.options.touchAction), ae(this, !0), a(e.recognizers, function(t) {
        ...
        t.MSPointerEvent && (ze = "MSPointerDown", Ve = "MSPointerMove MSPointerUp MSPointerCancel"), c(F, _, {
            handler: function(t) {
                var e = this.store,
                    i = !1,
        ...
        G.prototype = {
            set: function(t) {
                t == Qe && (t = this.compute()), Ke && (this.manager.element.style[qe] = t), this.actions = t.toLowerCase().trim()
            },
            update: function() {
        ...
        X.prototype = {
            ...
            requireFailure: function(t) {
                ...
                return t = q(t, this), -1 === b(e, t) && (e.push(t), t.requireFailure(this)), this
            },
            ...
            attrTest: function(t) {
                return K.prototype.attrTest.call(this, t) && (this.state & oi || !(this.state & oi) && this.directionTest(t))
            },
            emit: function(t) {
    ...
    a = a.MD5 = l.extend({
        ...
        _doProcessBlock: function(t, o) {
            ...
            var a = this._hash.words,
                ...
                w = i(w, k, C, _, S, 20, c[31]),
                _ = n(_, w, k, C, p, 4, c[32]),
                C = n(C, _, w, k, g, 11, c[33]),
                k = n(k, C, _, w, y, 16, c[34]),
...
function() {
    ...
    function a(t, e, i, n) {
        var s = [A(U(t).toString(16)), A(U(e).toString(16)), A(U(i).toString(16))];
    ...
    function r(t, e, i, n) {
        var s = [A(D(n)), A(U(t).toString(16)), A(U(e).toString(16)), A(U(i).toString(16))];
        return s.join("")
    }
    ...
    function l(t, e) {
        e = 0 === e ? 0 : e || 10;
        var i = B(t).toHsl();
        return i.s -= e / 100, i.s = _(i.s), B(i)
    }
    ...
    function h(t, e) {
        e = 0 === e ? 0 : e || 10;
        var i = B(t).toHsl();
        return i.l += e / 100, i.l = _(i.l), B(i)
    }

    function u(t, e) {
        e = 0 === e ? 0 : e || 10;
        var i = B(t).toRgb();
        return i.r = F(0, $(255, i.r - U(255 * -(e / 100)))), i.g = F(0, $(255, i.g - U(255 * -(e / 100)))), i.b = F(0, $(255, i.b - U(255 * -(e / 100)))), B(i)
    }
    ...
    function y(t, e, i) {
        ...
        var n = B(t).toHsl(),
            s = 360 / i,
            o = [B(t)];
        for (n.h = (n.h - (s * e >> 1) + 720) % 360; --e;) n.h = (n.h + s) % 360, o.push(B(n));
        return o
    }

    function S(t, e) {
        e = e || 6;
        for (var i = B(t).toHsv(), n = i.h, s = i.s, o = i.v, a = [], r = 1 / e; e--;) a.push(B({
            h: n,
            s: s,
            v: o
        })), o = (o + r) % 1;
    ...
    function L(t, e) {
        k(t) && (t = "100%");
        var i = C(t);
        return t = $(e, F(0, parseFloat(t))), i && (t = parseInt(t * e, 10) / 100), P.abs(t - e) < 1e-6 ? 1 : t % e / parseFloat(e)
    }
    ...
    var R = /^[\s,#]+/,
        ...
        j = P.random,
        B = function G(e, i) {
            if (e = e ? e : "", i = i || {}, e instanceof G) return e;
            if (!(this instanceof G)) return new G(e, i);
            var n = t(e);
            this._r = n.r, this._g = n.g, this._b = n.b, this._a = n.a, this._roundA = U(100 * this._a) / 100, this._format = i.format || n.format, this._gradientType = i.gradientType, this._r < 1 && (this._r = U(this._r)), this._g < 1 && (this._g = U(this._g)), this._b < 1 && (this._b = U(this._b)), this._ok = n.ok, this._tc_id = N++
        };
    B.prototype = {
        isDark: function() {
        ...
        for (var i = null, n = 0, s = !1, o = 0; o < e.length; o++) {
            ...
            (r && !s || r && s && l > n || !r && !s && l > n) && (s = r, n = l, i = B(e[o]))
        }
        return i
    };
    var H = B.names = {
...
function(t, e) {
    ...
    function N(t) {
        var e = t.D.m.offsetWidth,
            i = t.F.m.offsetWidth;
        e === t.I.serif && i === t.I["sans-serif"] || t.k.fa && O(t, e, i) ? q() - t.na >= t.W ? t.k.fa && O(t, e, i) && (null === t.ba || t.ba.hasOwnProperty(t.s.getName())) ? U(t, t.Z) : U(t, t.ja) : P(t) : U(t, t.Z)
    }
    ...
    v.prototype.parse = function() {
        ...
        } else if (-1 != this.a.indexOf("Opera")) t: if (t = m(E(this.a, /Presto\/([\d\w\.]+)/, 1)), m(y(this)), null !== t.c || m(E(this.a, /rv:([^\)]+)/, 1)), -1 != this.a.indexOf("Opera Mini/")) t = m(E(this.a, /Opera Mini\/([\d\.]+)/, 1)), t = new g("OperaMini", 0, 0, 0, b(this), 0, 0, new p(!1, !1));
            else {
        ...
        else /OPR\/[\d.]+/.test(this.a) ? t = S(this) : /AppleWeb(K|k)it/.test(this.a) ? t = S(this) : -1 != this.a.indexOf("Gecko") ? (t = "Unknown", e = new f, m(y(this)), e = !1, -1 != this.a.indexOf("Firefox") ? (t = "Firefox", e = m(E(this.a, /Firefox\/([\d\w\.]+)/, 1)), e = 3 <= e.c && 5 <= e.g) : -1 != this.a.indexOf("Mozilla") && (t = "Mozilla"), i = m(E(this.a, /rv:([^\)]+)/, 1)), e || (e = 1 < i.c || 1 == i.c && 9 < i.g || 1 == i.c && 9 == i.g && 2 <= i.A), t = new g(t, 0, 0, 0, b(this), 0, 0, new p(e, !1))) : t = Q;
        return t
    ...
    R.prototype.start = function() {
        this.D = new D(this.d, this.G), I(this.D), this.F = new D(this.d, this.G), I(this.F), this.na = q();
        ...
        var e = this.u;
        e.B && l(e.p, [e.h.e(e.j, t.getName(), _(t).toString(), "active")], [e.h.e(e.j, t.getName(), _(t).toString(), "loading"), e.h.e(e.j, t.getName(), _(t).toString(), "inactive")]), A(e, "fontactive", t), this.da = !0, j(this)
    }, $.prototype.ia = function(t) {
        var e = this.u;
        if (e.B) {
        ...
        for (i = c, this.T = this.U = i.length, t = new $(this.a, this.d, e, n), n = 0, a = i.length; a > n; n++) r = i[n], r.K(this.a, s(this.ka, this, r, e, t))
    }, B.prototype.ka = function(t, e, i, n) {
        var s = this;
        n ? t.load(function(t, e, n) {
            H(s, i, t, e, n)
        }) : (t = 0 == --this.U, this.T--, t && 0 == this.T ? C(e) : (this.Q || this.S) && F(i, [], {}, null, t))
    };
...
function(t, e, i) {
    ...
    return c.prototype = g, d(g, "__NPO__", 0, !1), d(c, "resolve", function(t) {
        ...
        function t() {
            e(), SL.helpers && SL.helpers.PageLoader.hide(), SL.settings.init(), SL.keyboard.init(), SL.pointer.init(), SL.warnings.init(), SL.draganddrop.init(), SL.fonts.init(), SL.visibility.init(), "undefined" == typeof SLConfig && (window.SLConfig = {}), i(), n()
        }
        ...
        function i() {
            "object" == typeof window.SLConfig && (SLConfig.deck && !SLConfig.deck.notes && (SLConfig.deck.notes = {}), SL.current_user = new SL.models.User(SLConfig.current_user), "object" == typeof SLConfig.deck && (SL.current_deck = new SL.models.Deck(SLConfig.deck)), "object" == typeof SLConfig.theme && (SL.current_theme = new SL.models.Theme(SLConfig.theme)), "object" == typeof SLConfig.team && (SL.current_team = new SL.models.Team(SLConfig.team)))
        }
        ...
        upload: function() {
            /\.svg$/i.test(this.uploadFile.name) && window.FileReader ? (SL.analytics.trackEditor("Media: SVG upload started"), this.reader = new window.FileReader, this.reader.addEventListener("abort", this.uploadValidated.bind(this)), this.reader.addEventListener("error", this.uploadValidated.bind(this)), this.reader.addEventListener("load", function(t) {
                ...
                if (i) {
                    ...
                    }), $(i).find("script").remove(), $(i).removeAttr("content"), $(i).find("[unicode]").each(function() {
        ...
        loadCustomFonts: function() {
            SL.fonts && (this.has("font_typekit") && SL.fonts.loadTypekitFont(this.get("font_typekit")), this.has("font_google") && SL.fonts.loadGoogleFont(this.get("font_google")))
        },
        clone: function() {
        ...
        toJSON: function() {
            return {
                ...
                font_typekit: this.get("font_typekit"),
                font_google: this.get("font_google"),
                html: this.get("html"),
                less: this.get("less"),
                css: this.get("css"),
                js: this.get("js"),
        ...
        parseCSSTransform: function(t) {
            ...
            return (t || "").split(" ").forEach(function(t) {
                ...
                })), i && n && (i = i.trim(), e[i] = 1 === n.length ? n[0] : n)
            }), e
        },
        ...
        setAceEditorDefaults: function(t) {
            t.setTheme("ace/theme/monokai"), t.setDisplayIndentGuides(!0), t.setShowPrintMargin(!1), t.renderer.setScrollMargin(10, 0), t.$blockScrolling = 1 / 0
        }
    }, SL.util.user = {
        isLoggedIn: function() {
        ...
        google_domain: function(t) {
            t = t || "";
            var e = [];
            return /\./gi.test(t) || e.push("Please enter a valid domain"), e
        },
        none: function() {
            return []
        }
        ...
        ASSET_URLS: {
            "offline-v2.css": "//assets.slid.es/assets/offline-v2-2c8d807b41d06750992b9180ec02b76a.css",
        ...
        INIT_TIMEOUT: 5e3,
        FONTS_URL: SLConfig.fonts_url || "css/",
        FAMILIES: {
            montserrat: {
                id: "montserrat",
                name: "Montserrat",
            ...
            josefinsans: {
                id: "josefinsans",
                name: "Josefin Sans",
                path: "josefinsans.css"
            },
            league: {
                id: "league",
                name: "League Gothic",
                path: "league_gothic.css"
            },
            merriweathersans: {
                id: "merriweathersans",
                name: "Merriweather Sans",
                path: "merriweathersans.css"
            },
            overpass: {
                id: "overpass",
                name: "Overpass",
        ...
        load: function(t, e) {
            ...
            return t.forEach(function(t) {
                ...
                families: []
            }, i.google.families = i.google.families.concat(SL.fonts.parseGoogleFontFamilies(SLConfig.deck.font_google)))), SLConfig && SLConfig.theme && (SLConfig.theme.font_typekit && (i.typekit = {
                id: SLConfig.theme.font_typekit
            }), SLConfig.theme.font_google && (i.google = i.google || {
                families: []
            }, i.google.families = i.google.families.concat(SL.fonts.parseGoogleFontFamilies(SLConfig.theme.font_google)))), this.debugMode && console.log("SL.fonts.load", i.custom.families), i.custom.families.length || i.typekit || i.google ? (WebFont.load(i), !0) : !1
        },
        loadAll: function(t) {
            var e = [];
            for (var i in SL.fonts.FAMILIES) e.push(i);
            this.load(e, t)
        },
        ...
        EXPORT_PPT_BUTTON: "Download PPTX",
        EXPORT_PPT_BUTTON_WORKING: "Creating PPTX...",
        EXPORT_PPT_ERROR: "An error occured while exporting to PowerPoint.",
    ...
    function(t) {
        ...
        paint: function(t, e) {
            ...
            if (e.js !== !1)
                if (t.get("js")) {
                    ...
                    a.text() !== t.get("js") && (a.remove(), $("body").append(["<", 'script id="theme-js-output">', t.get("js"), "<", "/script", ">"].join("")))
        ...
        init: function(t) {
            ...
            }, t), this.options.additionalHeaderActions && (this.options.headerActions = this.options.additionalHeaderActions.concat(this.options.headerActions)), this.closed = new signals.Signal, this.render(), this.bind(), this.layout()
        },
        render: function() {
        ...
        closeConfirmed: function() {
            ...
            }.bind(this), 500), this.closed.dispatch()
        },
        ...
        destroy: function() {
            SL.popup.unregister(this), this.options = null, this.closed.dispose(), this.domElement.remove()
        }
        ...
        init: function(t) {
            ...
            }, t)), this.loadGoogleFontList()
        },
        render: function() {
            return this._super(), this.bodyElement.append($(['<div class="sl-form">', '<div class="unit typekit-settings">', '<h4 class="form-label">Typekit</h4>', '<p class="unit-description">Specify a <a href="https://typekit.com/" target="_blank">Typekit</a> kit ID to load for this presentation.</p>', '<input type="text" maxlength="255" placeholder="Kit ID">', "</div>", '<div class="unit google-settings">', '<h4 class="form-label">Google Fonts</h4>', '<p class="unit-description">A list of comma separated font families to load from <a href="https://fonts.google.com/" target="_blank">Google Fonts</a>. Font weights can be indicated with a colon after the font family, for example: Open Sans:300,700</p>', '<input type="text" maxlength="255" placeholder="Droid Sans, Droid Serif:bold">', '<p class="status"></p>', "</div>", "<div>"].join(""))), this.options.deck || this.options.theme ? (this.googleStatus = this.bodyElement.find(".google-settings .status"), this.typekitInput = this.bodyElement.find(".typekit-settings input"), this.googleInput = this.bodyElement.find(".google-settings input"), this.googleInput.on("input", this.onGoogleInput.bind(this)), this.options.theme ? (this.typekitInput.val(this.options.theme.get("font_typekit") || ""), this.googleInput.val(this.options.theme.get("font_google") || "")) : (this.typekitInput.val(this.options.deck.get("font_typekit") || ""), this.googleInput.val(this.options.deck.get("font_google") || "")), void this.validateGoogleFonts()) : void this.bodyElement.html("Configuration error. Missing deck/theme model.")
        },
        ...
        searchGoogleFontList: function(t) {
            var e = [];
            if (t && t.length > 0) {
                for (var i = window.SLGoogleFontList, n = 0, s = i.length; s > n; n++) {
                    var o = i[n]; - 1 !== o.family.search(new RegExp(t, "i")) && e.push({
                        value: o.family,
        ...
        onSaveClicked: function(t) {
            ...
            }), this.saveLoader = Ladda.create(t.target)), this.saveLoader.start(), this.saveAndClose()
        },
        saveAndClose: function() {
            ...
            this.options.theme ? (this.saveLoader.stop(), this.options.theme.setAll({
                ...
                this.options.deck.setAll({
                    font_typekit: t,
                    font_google: e
                }), t.length && SL.fonts.loadTypekitFont(t), e.length && SL.fonts.loadGoogleFont(e), this.close(!0)
            }).fail(function() {
        ...
        validateGoogleFonts: function() {
            ...
            e += t.map(function(t) {
                return '<span class="status-item">' + t + "</span>"
            }).join(""), this.googleStatus.html(e), this.googleStatus.toggleClass("visible", t.length > 0)
        },
        destroy: function() {
            this.saveLoader && this.saveLoader.remove(), this._super()
        },
        ...
        render: function() {
            ...
            try {
                this.editor = ace.edit("ace-html"), SL.util.setAceEditorDefaults(this.editor), this.editor.getSession().setMode("ace/mode/html")
            } catch (t) {
                console.log("An error occurred while initializing the Ace editor.")
            }
            this.editor.getSession().setValue(this.options.html || ""), this.editor.focus()
        },
        saveAndClose: function() {
        ...
        afterConnect: function() {
            this.isConnected() || (this.flags.connected = !0, this.renderContent(), SL.activity.register(SL.config.COLLABORATION_IDLE_TIMEOUT, this.onUserActive.bind(this), this.onUserInactive.bind(this)), SL.visibility.changed.add(this.onVisibilityChanged.bind(this)), this.hideOverlay(), this.isEnabled() ? this.options.autofocusComment && this.comments.focus() : (this.setEnabled(!0), this.users.showInvitePrompt(this.menu.getPrimaryButton()), this.users.inviteSent.addOnce(this.expand.bind(this))), this.handover && this.handover.refresh(), this.isInEditor() && this.currentUserIsEditing() ? this.reloadCurrentUser().then(function() {
        ...
        redirectToEdit: function() {
            if (!this.isInEditor()) {
                ...
                window.location = SL.routes.DECK_EDIT(SL.current_deck.get("user").username, SL.current_deck.get("slug")) + t
            }
        },
        ...
        onKeyDown: function(t) {
            return 27 !== t.keyCode || this.options.fixed ? !0 : (this.collapse(), !1)
        },
        ...
        renderComment: function(t, e) {
            if (e = e || {}, !t.rendered) {
                ...
                r.data("model", t), this.refreshComment(r), this.refreshSlideNumber(r), SL.util.device.IS_PHONE || SL.util.device.IS_TABLET || this.renderCommentOptions(r, t), t.stateChanged.add(this.onCommentStateChanged.bind(this, r)), e.prepend ? this.domElement.prepend(r) : this.domElement.append(r), this.checkOverflow()
            }
        },
        ...
        render: function() {
            ...
            this.domElement.toggleClass("has-error", t.length > 0), t.length > 0 ? (this.errorElement.appendTo(this.domElement), this.errorMessage.text(t[0]), setTimeout(function() {
                this.errorElement.addClass("visible")
            }.bind(this), 1)) : this.errorElement.removeClass("visible").remove(), 0 === t.length && !this.isEmpty() && this.successText ? (this.successElement.appendTo(this.domElement), setTimeout(function() {
                this.successElement.addClass("visible")
            }.bind(this), 1)) : this.successElement.removeClass("visible").remove()
        },
        format: function() {
        ...
        isEmpty: function() {
            return 0 === this.inputElement.val().length
        },
        isRequired: function() {
        ...
        init: function(t, e, i) {
            this.options = $.extend({
                editable: !0
            }, i), this.media = t, this.media.changed.add(this.onMediaChanged.bind(this)), this.tags = e, this.tags.changed.add(this.onTagsChanged.bind(this)), this.tags.associationChanged.add(this.onTagAssociationChanged.bind(this)), this.filterChanged = new signals.Signal, this.onSearchInput = $.throttle(this.onSearchInput, 300), this.render(), this.recount(), this.selectDefaultFilter(!0)
        },
        render: function() {
        ...
        renderType: function(t, e, i, n) {
            ...
            }), s.on("vclick", this.onFilterClicked.bind(this)), s.data("filter", e), s.appendTo(this.innerElement), s
        },
        renderTags: function() {
        ...
        renderTag: function(t) {
            var e = $(['<div class="media-library-filter media-drop-target" data-id="' + t.get("id") + '">', '<div class="front">', '<span class="label-output">' + t.get("name") + "</span>", '<div class="controls-out">', '<span class="count"></span>', "</div>", "</div>", "</div>", "</div>"].join(""));
            return e.on("vclick", this.onTagClicked.bind(this)), e.data({
                model: t,
                filter: t.createFilter()
            }), this.options.editable ? (e.find(".front").append(['<div class="controls-over">', '<span class="controls-button edit-button">Edit</span>', "</div>"].join("")), e.append(['<div class="back">', '<input class="label-input" value="' + t.get("name") + '" type="text">', '<div class="controls">', '<span class="controls-button delete-button negative icon i-trash-stroke"></span>', '<span class="controls-button save-button">Save</span>', "</div>", "</div>"].join("")), e.data("dropReceiver", function(e) {
                this.tags.addTagTo(t, e)
            }.bind(this))) : e.find(".controls-out").removeClass("controls-out").addClass("controls-permanent"), e.appendTo(this.tagsList), e
        },
        ...
        recount: function(t) {
            t = t || this.domElement.find(".media-library-filter"), t.each(function(t, e) {
                var i = $(e),
                    n = i.find(".count");
        ...
        selectFilter: function(t, e) {
            ...
            this.domElement.find(".is-selected").removeClass("is-selected"), i.addClass("is-selected"), this.selectedFilter = i.data("filter"), this.selectedFilterData = {}, i.closest(this.tagsList).length ? (this.selectedFilterData.type = SL.components.medialibrary.Filters.FILTER_TYPE_TAG, this.selectedFilterData.tag = i.data("model"), this.selectedFilterData.placeholder = "No media has been added to this tag", this.options.editable && (this.selectedFilterData.placeholder = "This tag is empty. To add media, drag and drop it onto the tag in the sidebar.")) : (this.selectedFilterData.type = SL.components.medialibrary.Filters.FILTER_TYPE_MEDIA, this.selectedFilterData.placeholder = "There is no media of this type"), e || this.filterChanged.dispatch(this.selectedFilter, this.selectedFilterData)
        },
        ...
        showAllTypes: function() {
            this.domElement.find(".media-library-type-filter").each(function() {
                var t = $(this);
                t.css("display", ""), t.find(".label").text(t.attr("data-label"))
            })
        },
        ...
        startEditingTag: function(t, e) {
            ...
            this.domElement.addClass("is-editing"), e === !0 && (t.addClass("collapsed"), t.find(".label-output").empty(), setTimeout(function() {
                t.removeClass("collapsed")
            }, 1), this.scrollElement.animate({
                scrollTop: t.prop("offsetTop") + 80 - this.scrollElement.height()
            }, 300)), t.addClass("is-editing");
            var n = this.scrollElement.prop("scrollTop");
            i.focus().select(), this.scrollElement.prop("scrollTop", n), i.on("keydown", function(e) {
        ...
        stopEditingTag: function(t, e) {
            ...
            var o = n.val();
            o && !e && (i.set("name", o), i.save(["name"])), s.text(i.get("name")), n.off("keydown"), setTimeout(function() {
        ...
        sortTags: function() {
            ...
            t.sort(function(t, e) {
                return t = $(t).data("model").get("name").toLowerCase(), e = $(e).data("model").get("name").toLowerCase(), e > t ? -1 : t > e ? 1 : 0
            }), t.forEach(function(t) {
        ...
        confirmTagRemoval: function(t) {
            ...
            SL.prompt({
                ...
                data: [{
                    ...
                    className: "negative",
                    callback: function() {
                        SL.analytics.trackEditor("Media: Delete tag"), e.destroy().done(function() {
                            this.domElement.removeClass("is-editing"), this.tags.remove(e), SL.notify(SL.locale.get("MEDIA_TAG_DELETE_SUCCESS"))
        ...
        onTagsChanged: function(t, e) {
            ...
            }.bind(this)), e && e.length && e.forEach(function(t) {
                var e = this.tagsElement.find('[data-id="' + t.get("id") + '"]');
                this.stopEditingTag(e, !0), e.css({
                    height: 0,
                    padding: 0,
                    opacity: 0
                }), setTimeout(function() {
                    e.remove()
                }, 300), e.hasClass("is-selected") && this.selectDefaultFilter()
            }.bind(this))
        },
        ...
        onCreateTagClicked: function() {
            this.tagsCreateLoader.start(), this.tags.create().then(function(t) {
                this.recount(this.getTagElementByID(t.get("id"))), this.tagsCreateLoader.stop()
            }.bind(this), function() {
        ...
        onSearchClicked: function() {
            this.selectFilter(this.searchElement.attr("data-id"), !0), this.searchInput.focus(), this.onSearchInput(), SL.analytics.trackEditor("Media: Search clicked")
        },
        onSearchInput: function() {
            var t = this.searchInput.val();
            this.selectedFilter = this.media.createSearchFilter(t), this.selectedFilterData = {
                type: SL.components.medialibrary.Filters.FILTER_TYPE_SEARCH,
                placeholder: "Please enter a search term"
            }, this.searchElement.data("filter", this.selectedFilter), t.length > 0 && (this.selectedFilterData.placeholder = 'No results for "' + t + '"'), this.filterChanged.dispatch(this.selectedFilter, this.selectedFilterData)
        }
    }), SL.components.medialibrary.Filters.FILTER_TYPE_MEDIA = "media", SL.components.medialibrary.Filters.FILTER_TYPE_TAG = "tag", SL.components.medialibrary.Filters.FILTER_TYPE_SEARCH = "search", SL("components.medialibrary").ListDrag = Class.extend({
        init: function() {
        ...
        startDrag: function(t, e, i) {
            ...
            this.ghostOffset = {
                x: n.left - t.clientX,
                y: n.top - t.clientY
            }, this.ghostWidth = e.width(), this.ghostHeight = e.height(), this.ghostElement = $('<div class="media-library-drag-ghost">'), this.ghostElement.css({
                border: e.css("border"),
        ...
        onMouseMove: function(t) {
            ...
            this.ghostElement.css({
                webkitTransform: n,
                transform: n
            }), this.currentDropTarget = null, this.dropTargets.each(function(t, n) {
                var s = $(n),
        ...
        bind: function() {
            if (this.loadItemsInView = $.throttle(this.loadItemsInView, 200), this.onMouseMove = this.onMouseMove.bind(this), this.onMouseUp = this.onMouseUp.bind(this), this.domElement.on("scroll", this.onListScrolled.bind(this)), this.trayElement.find(".delete-button").on("vclick", this.onDeleteSelectionClicked.bind(this)), this.trayElement.find(".untag-button").on("vclick", this.onUntagSelectionClicked.bind(this)), this.trayElement.find(".clear-button").on("vclick", this.onClearSelectionClicked.bind(this)), SL.util.device.IS_PHONE || SL.util.device.IS_TABLET) {
                ...
                t.on("tap", this.onMouseUp), t.on("press", function(t) {
                    var e = $(t.target).closest(".media-library-list-item").data("item");
                    e && (this.lastSelectedItem = e, this.toggleSelection(e)), t.preventDefault()
                }.bind(this))
            } else this.domElement.on("vmousedown", this.onMouseDown.bind(this))
        },
        layout: function() {
            var t = $(".media-library-list-item").first();
            this.cellWidth = t.outerWidth(!0), this.cellHeight = t.outerHeight(!0), this.columnCount = Math.floor(this.domElement.outerWidth() / this.cellWidth)
        },
        appendTo: function(t) {
            this.domElement.appendTo(t), this.trayElement.appendTo(t), this.placeholderElement.appendTo(t), this.layout(), this.loadItemsInView()
        },
        addItem: function(t, e, i) {
            ...
            n.data("item", s), e === !0 ? (n.prependTo(this.domElement), this.items.unshift(s)) : (n.appendTo(this.domElement), this.items.push(s)), i === !0 && (n.addClass("has-intro hidden"), setTimeout(function() {
        ...
        setPrimaryFilter: function(t) {
            this.filterA = t, this.applyFilter()
        },
        clearPrimaryFilter: function() {
            this.filterA = null, this.applyFilter()
        },
        setSecondaryFilter: function(t, e) {
            this.clearSelection(), this.filterB = t, this.filterBData = e, this.applyFilter(), this.setPlaceholderContent(e.placeholder), this.afterSelectionChange()
        },
        ...
        loadItemsInView: function() {
            if (SL.tooltip.isVisible() && SL.tooltip.hide(), this.filteredItems.length)
                for (var t, e, i = this.domElement.scrollTop(), n = 100, s = this.domElement.outerHeight(), o = 0, a = this.filteredItems.length; a > o; o++) t = this.filteredItems[o], e = Math.floor(o / this.columnCount) * this.cellHeight, e + this.cellHeight - i > -n && s + n > e - i ? (t.overlay || this.attachOverlay(t), t.elementNode.hasAttribute("data-thumb-loaded") || (t.elementNode.style.backgroundImage = 'url("' + t.model.get("thumb_url") + '")', t.elementNode.setAttribute("data-thumb-loaded", "true"))) : t.overlay && !t.selected && this.detachOverlay(t)
        },
        ...
        refreshOverlay: function(t) {
            if (t.overlay) {
                ...
                e && "" !== e || (e = "Label"), t.overlay.attr("data-tooltip", e), t.model.isSVG() ? (t.overlay.addClass("has-inline-option"), t.overlay.find(".inline-button").toggleClass("is-on", !!t.model.get("inline"))) : t.overlay.removeClass("has-inline-option")
            }
        },
        ...
        toggleSelectionThrough: function(t) {
            if (this.lastSelectedItem) {
                var e = !t.selected,
                    ...
                    n = t.element.index();
                if (n > i)
                    for (var s = i + 1; n >= s; s++) this.toggleSelection(this.items[s], e);
                else if (i > n)
                    for (var s = n; i > s; s++) this.toggleSelection(this.items[s], e)
            }
        },
        clearSelection: function() {
            this.selectedItems.forEach(function(t) {
                t.selected = !1, t.element.removeClass("is-selected")
        ...
        deleteSelection: function() {
            ...
            this.selectedItems.size() > 1 && (t = "Do you want to permanently delete these items from all existing presentations or remove them from the library?"), SL.prompt({
                ...
                data: [{
                    ...
                    callback: function() {
                        this.selectedItems.forEach(function(t) {
                            t.model.set("hidden", !0), t.model.save(["hidden"]).fail(function() {
                                SL.notify("An error occurred, media was not removed", "negative")
                            }.bind(this)), this.media.remove(t.model)
        ...
        editLabel: function(t) {
            ...
            e.confirmed.add(function(e) {
                t.element.removeClass("hover"), e && "" !== e.trim() ? (t.model.set("label", e), t.model.save(["label"]), this.refreshOverlay(t)) : SL.notify("Label can't be empty", "negative")
            }.bind(this)), e.canceled.add(function() {
                t.element.removeClass("hover")
            }.bind(this)), SL.analytics.trackEditor("Media: Edit item label")
        },
        toggleInline: function(t) {
            t.model.set("inline", !t.model.get("inline")), t.model.save(["inline"]), this.refreshOverlay(t), SL.analytics.trackEditor("Media: Toggle inline SVG")
        },
        onMediaChanged: function(t, e) {
            t && t.length && (t.forEach(function(t) {
                this.addItem(t, !0, !0)
            }.bind(this)), this.applyFilter()), e && e.length && (e.forEach(this.removeItem.bind(this)), this.media.isEmpty() ? this.applyFilter() : this.loadItemsInView())
        },
        onTagAssociationChanged: function(t) {
            ...
            if (e > 10 && this.options.editable) {
                ...
                if (i) {
                    ...
                    this.selectedItems.size() > 0 && i.selected && (n = this.selectedItems.map(function(t) {
                        return t.model
                    })), this.drag.startDrag(t, i.element, n), SL.analytics.trackEditor("Media: Start drag", n.length > 1 ? "multiple" : "single")
                }
            }
            t.preventDefault()
        },
        onMouseUp: function(t) {
            ...
            i && (this.selectedItems.size() > 0 || e.closest(".select-button").length ? t.shiftKey ? this.toggleSelectionThrough(i) : (this.lastSelectedItem = i, this.toggleSelection(i)) : e.closest(".label-button").length ? this.editLabel(i) : e.closest(".inline-button").length ? this.toggleInline(i) : this.itemSelected.dispatch(i.model)), this.domElement.off("vmousemove", this.onMouseMove), this.domElement.off("vmouseup", this.onMouseUp), t.preventDefault()
        },
        ...
        onUntagSelectionClicked: function() {
            if (this.filterBData && this.filterBData.type === SL.components.medialibrary.Filters.FILTER_TYPE_TAG) {
                ...
                this.tags.removeTagFrom(this.filterBData.tag, t), this.applyFilter(), this.clearSelection()
            }
        },
        onClearSelectionClicked: function() {
            this.clearSelection()
        }
    }), SL("components.medialibrary").MediaLibraryPage = Class.extend({
        init: function(t, e, i) {
            this.media = t, this.media.loadCompleted.add(this.onMediaLoaded.bind(this)), this.media.loadFailed.add(this.onMediaFailed.bind(this)), this.tags = e, this.tags.loadCompleted.add(this.onTagsLoaded.bind(this)), this.tags.loadFailed.add(this.onTagsFailed.bind(this)), this.tags.changed.add(this.onTagsChanged.bind(this)), this.options = $.extend({
                editable: !0,
                selectAfterUpload: !0
            }, i), this.selected = new signals.Signal, this.render(), this.setupDragAndDrop()
        },
        load: function() {
            this.mediaLoaded = !1, this.tagsLoaded = !1, this.loadStatus && this.loadStatus.remove(), this.loadStatus = $('<div class="media-library-load-status">').appendTo(this.domElement), this.loadStatus.html("Loading..."), this.media.load(), this.tags.load()
        },
        onMediaLoaded: function() {
            this.mediaLoaded = !0, this.tagsLoaded && this.onMediaAndTagsLoaded()
        },
        ...
        onTagsLoaded: function() {
            this.tagsLoaded = !0, this.mediaLoaded && this.onMediaAndTagsLoaded()
        },
        ...
        renderFilters: function() {
            this.filters = new SL.components.medialibrary.Filters(this.media, this.tags, {
                editable: this.isEditable()
            }), this.filters.filterChanged.add(this.onFilterChanged.bind(this)), this.filters.appendTo(this.sidebarElement)
        },
        renderUploader: function() {
            this.isEditable() && (this.uploader = new SL.components.medialibrary.Uploader(this.media), this.uploader.uploadEnqueued.add(this.onUploadEnqueued.bind(this)), this.uploader.uploadStarted.add(this.onUploadStarted.bind(this)), this.uploader.uploadCompleted.add(this.onUploadCompleted.bind(this)), this.uploader.appendTo(this.sidebarElement))
        },
        renderList: function() {
            this.list = new SL.components.medialibrary.List(this.media, this.tags, {
                editable: this.isEditable()
            }), this.list.itemSelected.add(this.select.bind(this)), this.list.appendTo(this.contentElement)
        },
        setupDragAndDrop: function() {
            this.dragAndDropInstructions = $(['<div class="media-library-drag-instructions">', '<div class="inner">', "Drop to upload media", "</div>", "</div>"].join("")), this.dragAndDropListener = {
                ...
                onDrop: function(t) {
                    ...
                    if (this.isSelecting()) this.uploader.enqueue(e[0]);
                    else
                        for (var i = 0; i < e.length; i++) this.uploader.enqueue(e[i]);
                    SL.analytics.trackEditor("Media: Upload file", "drop from desktop")
                }.bind(this)
            }
        },
        show: function(t) {
            this.domElement.appendTo(t), this.domElement.removeClass("visible"), clearTimeout(this.showTimeout), this.showTimeout = setTimeout(function() {
                this.domElement.addClass("visible")
        ...
        unbind: function() {
            this.dragAndDropInstructions.remove(), SL.draganddrop.unsubscribe(this.dragAndDropListener)
        },
        configure: function(t) {
            this.options = $.extend(this.options, t), this.refresh()
        },
        refresh: function() {
            this.media && this.media.isLoaded() && (this.list.clearSelection(), this.uploader && this.uploader.configure({
        ...
        layout: function() {
            var t = this.sidebarElement.width();
            this.contentElement.css({
                width: this.domElement.width() - t,
                left: t,
                paddingLeft: 0
            }), this.list && this.list.layout()
        },
        select: function(t) {
            this.selected.dispatch(t)
        },
        ...
        onFilterChanged: function(t, e) {
            this.list.setSecondaryFilter(t, e)
        },
        onUploadEnqueued: function(t) {
            var e = this.filters.getSelectedFilterData();
            e.type === SL.components.medialibrary.Filters.FILTER_TYPE_TAG && t.uploadCompleted.add(function() {
                this.tags.addTagTo(e.tag, [t])
            }.bind(this))
        },
        onUploadStarted: function(t) {
            this.isSelecting() && this.options.selectAfterUpload && this.select(t)
        },
        onUploadCompleted: function(t) {
            this.media.push(t)
        },
        ...
        init: function(t) {
            this._super($.extend({
                ...
                height: 660,
                singleton: !0
            }, t)), this.selected = new signals.Signal
        },
        render: function() {
            if (this._super(), this.innerElement.addClass("media-library"), this.userPage = new SL.components.medialibrary.MediaLibraryPage(new SL.collections.Media, new SL.collections.MediaTags), this.userPage.selected.add(this.onMediaSelected.bind(this)), this.userPage.load(), SL.current_user.isEnterprise()) {
                ...
                }.bind(this)), t.loadFailed.add(function() {
                    this.teamTab.attr("data-tooltip", "Failed to load")
                }.bind(this)), this.teamPage = new SL.components.medialibrary.MediaLibraryPage(t, new SL.collections.TeamMediaTags, {
        ...
        open: function(t) {
            t = $.extend({
                select: null
            }, t), this._super(t), this.currentPage.configure(t), this.currentPage.bind(), this.refresh(), this.layout()
        },
        close: function() {
        ...
        init: function(t) {
            this.media = t, this.options = {
                multiple: !0
            }, this.queue = new SL.collections.Collection, this.render(), this.renderInput(), this.bind()
        },
        bind: function() {
        ...
        configure: function(t) {
            this.options = $.extend(this.options, t), this.renderInput()
        },
        appendTo: function(t) {
            this.domElement.appendTo(t)
        },
        ...
        enqueue: function(t) {
            ...
            }.bind(this)), this.queue.push(e), this.uploadEnqueued.dispatch(e), this.checkQueue()
        },
        ...
        checkQueue: function() {
            ...
            }.bind(this)), this.domElement.toggleClass("is-uploading", t > 0)
        },
        onUploadCompleted: function() {
            this.checkQueue()
        },
        onUploadFailed: function(t) {
            SL.notify(t || "An error occurred while uploading your image.", "negative"), this.checkQueue()
        },
        onInputChanged: function(t) {
            var e = SL.util.toArray(this.fileInput.get(0).files);
            e = e.filter(this.validateFile.bind(this)), e.length ? (e.forEach(this.enqueue.bind(this)), SL.analytics.trackEditor("Media: Upload file", "file input")) : SL.notify("Invalid file. We support <strong>PNG</strong>, <strong>JPG</strong>, <strong>GIF</strong> and <strong>SVG</strong> files up to <strong>10 MB</strong>", "negative"), this.renderInput(), t.preventDefault()
        },
        destroy: function() {
        ...
        render: function() {
            this.domElement = $('<div class="sl-menu">'), this.listElement = $('<div class="sl-menu-list">').appendTo(this.domElement), this.arrowElement = $('<div class="sl-menu-arrow">').appendTo(this.domElement), this.arrowFillElement = $('<div class="sl-menu-arrow-fill">').appendTo(this.arrowElement), this.hitareaElement = $('<div class="sl-menu-hitarea">').appendTo(this.domElement), this.listElement.css("minWidth", this.config.minWidth + "px")
        },
        renderList: function() {
            this.config.options.forEach(function(t) {
                var e;
        ...
        bind: function() {
            this.config.showOnHover || SL.keyboard.keydown(this.onDocumentKeydown), $(window).on("resize scroll", this.layout), $(document).on("mousedown touchstart pointerdown", this.onDocumentMouseDown)
        },
        unbind: function() {
            this.config.showOnHover || SL.keyboard.release(this.onDocumentKeydown), SL.keyboard.release(this.onAnchorFocusKeyDown), $(window).off("resize scroll", this.layout), $(document).off("mousedown touchstart pointerdown", this.onDocumentMouseDown)
        },
        layout: function() {
            if (this.config.anchor.length) {
                var t = this.config.anchor.offset(),
                    ...
                    p = c / 2,
                    f = 8;
                switch ("auto" === i && (i = t.top - (d + e + f) < s ? "b" : "t"), "rl" === i && (i = t.left + r + e + f + c < window.innerWidth ? "r" : "l"), this.domElement.attr("data-alignment", i), i) {
                    case "t":
                        o += (r - c) / 2, a -= d + e;
                        break;
                    case "b":
                ...
                switch (o = Math.min(Math.max(o, n + e), $(window).width() + n - c - e), a = Math.min(Math.max(a, s + e), window.innerHeight + s - d - e), i) {
                    case "t":
                        u = t.left - o + r / 2, p = d - 2 * h;
                        break;
                    case "b":
                        u = t.left - o + r / 2, p = -f;
                        break;
                    case "l":
                        u = c - 2 * h, p = t.top - a + l / 2;
                        break;
                    case "r":
                        u = -f, p = t.top - a + l / 2
                }
        ...
        onMouseOver: function() {
            this.isMouseOver || SL.pointer.isDown() || ("function" != typeof this.config.showOnHoverCondition || this.config.showOnHoverCondition()) && ($(document).on("mousemove", this.onDocumentMouseMove), this.hideTimeout = -1, this.isMouseOver = !0, this.show())
        },
        onDocumentMouseMove: function(t) {
            var e = $(t.target),
                i = 0 === e.closest(this.domElement).length && 0 === e.closest(this.config.anchor).length;
            this.hasSubMenu() && (i = 0 === e.closest(".sl-menu").length && 0 === e.closest(this.config.anchor).length), i ? -1 === this.hideTimeout && (clearTimeout(this.hideTimeout), this.hideTimeout = setTimeout(this.hide, this.config.mouseLeaveDelay)) : this.hideTimeout && (clearTimeout(this.hideTimeout), this.hideTimeout = -1)
        },
        onDocumentMouseDown: function(t) {
            var e = $(t.target);
        ...
        init: function(t) {
            this.domElement = $(t), this.labelElement = $('<div class="label">').appendTo(this.domElement), this.progressElement = $('<div class="progress">').appendTo(this.domElement), this.read(), this.paint()
        },
        read: function() {
        ...
        renderRange: function() {
            this.rangeInput = new SL.components.Range(this.config.data), this.rangeInput.appendTo(this.innerElement), "number" == typeof this.config.data.width && (this.titleElement && this.titleElement.css("max-width", this.config.data.width), this.subtitleElement && this.subtitleElement.css("max-width", this.config.data.width))
        },
        ...
        layout: function() {
            ...
            if (o.length) {
                ...
                var y = u;
                switch (h = Math.max(Math.min(h, e - n - t), t), u = Math.max(Math.min(u, i - s - t), t), h = Math.round(h), u = Math.round(u), "b" === l && -f - v > u - y ? b = !1 : "t" === l && u - y > f + v && (b = !1), l) {
                    case "t":
        ...
        getValue: function() {
            var t = void 0;
            return "input" === this.config.type ? t = this.inputElement.val() : "range" === this.config.type && (t = this.rangeInput.getValue()), t
        },
        ...
        init: function(t) {
            this.config = $.extend({
                ...
                decimals: 0,
                unit: null
            }, t), this.valueRange = this.config.maxValue - this.config.minValue, this.stepSize = this.valueRange < 1 ? this.valueRange / 200 : 1, this.changing = !1, this.mouseDownValue = 0, this.mouseDownX = 0, this.render(), this.bind(), this.setValue(t.value, !1)
        },
        render: function() {
            this.domElement = $('<div class="sl-range"></div>'), this.domElement.width(this.config.width), this.progressElement = $('<div class="sl-range-progress">').appendTo(this.domElement), this.inputElement = $('<input class="sl-range-number input-field" type="text">').appendTo(this.domElement)
        },
        bind: function() {
            this.changed = new signals.Signal, this.changeStarted = new signals.Signal, this.changeEnded = new signals.Signal, this.onMouseDown = this.onMouseDown.bind(this), this.onMouseMove = this.onMouseMove.bind(this), this.onMouseUp = this.onMouseUp.bind(this), this.domElement.on("vmousedown", this.onMouseDown), this.inputElement.on("input", this.onInput.bind(this)), this.inputElement.on("keydown", this.onInputKeyDown.bind(this)), this.inputElement.on("focus", this.onInputFocused.bind(this)), this.inputElement.on("blur", this.onInputBlurred.bind(this))
        },
        appendTo: function(t) {
            this.domElement.appendTo(t)
        },
        setValue: function(t, e, i) {
            if (this.value = Math.max(Math.min(t, this.config.maxValue), this.config.minValue), this.value = this.roundValue(this.value), !i) {
                var n = this.value;
                this.config.decimals > 0 && (n = n.toFixed(this.config.decimals)), this.config.unit && (n += this.config.unit), this.inputElement.val(n)
            }
            var s = this.valueToPercent(this.value) / 100;
            this.progressElement.css("transform", "scaleX(" + s + ")"), e && this.changed.dispatch(this.value)
        },
        getValue: function() {
            return this.value
        },
        ...
        onMouseDown: function(t) {
            this.inputElement.is(":focus") || t.preventDefault(), $(document).on("vmousemove", this.onMouseMove), $(document).on("vmouseup", this.onMouseUp), this.mouseDownX = t.clientX, this.mouseDownValue = this.getValue(), this.onChangeStart()
        },
        onMouseMove: function(t) {
            this.domElement.addClass("is-scrubbing");
            var e = t.clientX - this.mouseDownX;
            1 === this.stepSize && this.valueRange < 15 ? e *= .25 : 1 === this.stepSize && this.valueRange < 30 && (e *= .5), this.setValue(this.mouseDownValue + e * this.stepSize, !0), this.changed.dispatch(this.getValue())
        },
        onMouseUp: function(t) {
            $(document).off("vmousemove", this.onMouseMove), $(document).off("vmouseup", this.onMouseUp), this.domElement.hasClass("is-scrubbing") === !1 ? this.onClick(t) : this.onChangeEnd(), this.domElement.removeClass("is-scrubbing")
        },
        onClick: function() {
            this.inputElement.focus()
        },
        ...
        onInputKeyDown: function(t) {
            var e = 0;
            38 === t.keyCode ? e = this.stepSize : 40 === t.keyCode && (e = -this.stepSize), e && (t.shiftKey && (e *= 10), this.setValue(this.getValue() + e, !0), t.preventDefault())
        },
        ...
        destroy: function() {
            $(document).off("vmousemove", this.onMouseMove), $(document).off("vmouseup", this.onMouseUp), this.changed.dispose(), this.changeStarted.dispose(), this.changeEnded.dispose(), this.domElement.remove()
        }
        ...
        renderHTMLInput: function() {
            ...
            try {
                this.codeEditor = ace.edit(this.inputElement.get(0)), SL.util.setAceEditorDefaults(this.codeEditor), this.codeEditor.getSession().setMode("ace/mode/html")
            } catch (t) {
                console.log("An error occurred while initializing the Ace editor.")
            }
        },
        ...
        setValue: function(t) {
            this.originalValue = t || "", this.codeEditor ? this.codeEditor.getSession().setValue(t || "") : this.inputElement.val(t)
        },
        getValue: function() {
            return this.codeEditor ? this.codeEditor.getSession().getValue() : this.inputElement.val()
        },
        onBackgroundClicked: function(t) {
        ...
        init: function(t) {
            ...
            }, t), this.theme = t.model, this.changed = new signals.Signal, this.render(), this.updateSelection(), this.toggleDeprecatedOptions(), this.scrollToTop(), this.loadFonts()
        },
        render: function() {
        ...
        renderFonts: function() {
            var t = $('<div class="section selector font"><h3 class="section-heading">Typography</h3><ul></ul></div>').appendTo(this.domElement),
                e = t.find("ul");
            if (this.config.supportsCustomFonts) {
                var i = "You can use custom fonts from Typekit, Google or your own host. Click to learn more.",
                    n = "http://help.slides.com/knowledgebase/articles/1077976";
                this.config.themeEditor && (n = "http://help.slides.com/knowledgebase/articles/590055-theme-editor-custom-font"), t.find(".section-heading").append('<a href="' + n + '" target="_blank" class="info-link" data-tooltip="' + i + '" data-tooltip-maxwidth="240">Custom fonts</a>')
            }
        ...
        loadFonts: function() {
            setTimeout(function() {
                SL.fonts.fontactive.add(this.onFontLoaded.bind(this)), SL.fonts.fontinactive.add(this.onFontLoaded.bind(this)), SL.fonts.loadAll()
            }.bind(this), 500)
        },
        onFontLoaded: function() {
            $(".font li[data-font]").each(function(t, e) {
                e = $(e), SL.fonts.isPackageLoaded(e.attr("data-font")) && e.addClass("font-loaded")
            }.bind(this))
        },
                ...
                if (n) {
                    if (!n.isLoading()) {
                        ...
                        SL.util.html.generateSpinners(), e.addClass("selected"), n.load().done(function() {
                            this.theme = n.clone(), this.theme.loadCustomFonts(), this.updateSelection(), this.applySelection(), this.changed.dispatch()
                        }.bind(this)).fail(function() {
        ...
        function i(t, e) {
            if (!SL.util.device.IS_PHONE && !SL.util.device.IS_TABLET) {
                ...
                a.css("opacity", 0), a.appendTo(document.body), r.html(t), a.css({
                    ...
                    duration: 150
                }), $(window).on("resize scroll", n), $(d.anchor).parents(".sl-scrollable").on("scroll", n)
            }
        }
        ...
        function n() {
            ...
            if (t.length) {
                ...
                switch (e) {
                    case "t":
                        b = o.x - g - n + c / 2, y = m, b = Math.min(Math.max(b, S), f - S);
                        break;
                    case "b":
                        b = o.x - g - n + c / 2, y = -h, b = Math.min(Math.max(b, S), f - S);
                        break;
                    case "l":
                        b = f, y = o.y - v - s + p / 2, y = Math.min(Math.max(y, S), m - S);
                        break;
                    case "r":
                        b = -h, y = o.y - v - s + p / 2, y = Math.min(Math.max(y, S), m - S)
                }
                l.css({
                    left: Math.round(b),
                    top: Math.round(y)
        ...
        function s() {
            o() && (f = Date.now()), clearTimeout(p), a.remove().stop(!0, !0), $(window).off("resize scroll", n), d && $(d.anchor).parents(".sl-scrollable").off("scroll", n)
        }
    ...
    }), SL.views.decks.Speaker.LAYOUT_DEFAULT = "default", SL.views.decks.Speaker.LAYOUT_WIDE = "wide", SL.views.decks.Speaker.LAYOUT_TALL = "tall", SL.views.decks.Speaker.LAYOUT_NOTES_ONLY = "notes-only";